...
// For SIM7000 shield
#define FONA_PWRKEY ARDUINO_12_PIN
#define FONA_RST 6
//#define FONA_DTR 8 // Connect with solder jumper
//#define FONA_RI 9 // Need to enable via AT commands
#define FONA_TX ARDUINO_8_PIN // Microcontroller RX
#define FONA_RX ARDUINO_7_PIN // Microcontroller TX
...
void setup() {
  ...
  fona.begin(19200); // Default baud rate
//  fona.begin(4800);
